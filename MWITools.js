...
(() => {
    ...
    const REAL_TIME_MARKET_API_URL = "https://raw.githubusercontent.com/holychikenz/MWIApi/main/milkyapi.json";
    ...
    let settingsMap = {
        ...
        itemTooltip_realTimePrices: {
            id: "itemTooltip_realTimePrices",
            desc: isZH
                ? "使用实时市场价值 [依赖上一项]"
                : "Use real-time market value. [Depends on the previous selection]",
            isTrue: true,
        },
        showConsumTips: {
            id: "showConsumTips",
    ...
    async function fetchMarketJSON(forceFetch = false) {
        ...
        const response = await sendRequest({
            url: settingsMap.useGithubProxy.isTrue ? MARKET_API_URL_PROXY : (settingsMap.itemTooltip_realTimePrices ? REAL_TIME_MARKET_API_URL : MARKET_API_URL),
            method: "GET",
            synchronous: true,
            timeout: 5000,
            onload: (response) => {
